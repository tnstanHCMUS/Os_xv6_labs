...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      96:	2ce50513          	add	a0,a0,718 # 1360 <malloc+0x100>
      9a:	00001097          	auipc	ra,0x1
      9e:	e0e080e7          	jalr	-498(ra) # ea8 <mkdir>
  if(chdir("grindir") != 0){
      a2:	00001517          	auipc	a0,0x1
      a6:	2be50513          	add	a0,a0,702 # 1360 <malloc+0x100>
    ...
    printf("grind: chdir grindir failed\n");
      ...
      c0:	2ac50513          	add	a0,a0,684 # 1368 <malloc+0x108>
  ...
  chdir("/");
      ...
      e2:	2b250513          	add	a0,a0,690 # 1390 <malloc+0x130>
      e6:	00001097          	auipc	ra,0x1
      ea:	dca080e7          	jalr	-566(ra) # eb0 <chdir>
      ee:	00001997          	auipc	s3,0x1
      f2:	2b298993          	add	s3,s3,690 # 13a0 <malloc+0x140>
      f6:	c489                	beqz	s1,100 <go+0x88>
      f8:	00001997          	auipc	s3,0x1
      fc:	2a098993          	add	s3,s3,672 # 1398 <malloc+0x138>
  uint64 iters = 0;
     100:	4481                	li	s1,0
  int fd = -1;
     102:	5a7d                	li	s4,-1
     104:	00001917          	auipc	s2,0x1
     108:	56c90913          	add	s2,s2,1388 # 1670 <malloc+0x410>
    ...
    if(what == 1){
     ...
     116:	29650513          	add	a0,a0,662 # 13a8 <malloc+0x148>
    ...
    int what = rand() % 23;
     ...
     174:	24850513          	add	a0,a0,584 # 13b8 <malloc+0x158>
     ...
     18e:	21e50513          	add	a0,a0,542 # 13a8 <malloc+0x148>
     ...
     1a0:	1c450513          	add	a0,a0,452 # 1360 <malloc+0x100>
     ...
     1fc:	1e050513          	add	a0,a0,480 # 13d8 <malloc+0x178>
     ...
     21e:	1ce50513          	add	a0,a0,462 # 13e8 <malloc+0x188>
     ...
     28e:	18650513          	add	a0,a0,390 # 1410 <malloc+0x1b0>
     ...
     2cc:	16850513          	add	a0,a0,360 # 1430 <malloc+0x1d0>
     ...
     2de:	15e50513          	add	a0,a0,350 # 1438 <malloc+0x1d8>
     2e2:	00001097          	auipc	ra,0x1
     2e6:	bae080e7          	jalr	-1106(ra) # e90 <unlink>
      link("../grindir/./../a", "../b");
     2ea:	00001597          	auipc	a1,0x1
     2ee:	0e658593          	add	a1,a1,230 # 13d0 <malloc+0x170>
     2f2:	00001517          	auipc	a0,0x1
     2f6:	14e50513          	add	a0,a0,334 # 1440 <malloc+0x1e0>
     ...
     308:	15450513          	add	a0,a0,340 # 1458 <malloc+0x1f8>
     30c:	00001097          	auipc	ra,0x1
     310:	b84080e7          	jalr	-1148(ra) # e90 <unlink>
      link(".././b", "/grindir/../a");
     314:	00001597          	auipc	a1,0x1
     318:	0c458593          	add	a1,a1,196 # 13d8 <malloc+0x178>
     31c:	00001517          	auipc	a0,0x1
     320:	14c50513          	add	a0,a0,332 # 1468 <malloc+0x208>
     ...
     354:	12050513          	add	a0,a0,288 # 1470 <malloc+0x210>
     ...
     3a2:	0d250513          	add	a0,a0,210 # 1470 <malloc+0x210>
     ...
     402:	09250513          	add	a0,a0,146 # 1490 <malloc+0x230>
     ...
     42e:	05e50513          	add	a0,a0,94 # 1488 <malloc+0x228>
     ...
     450:	02450513          	add	a0,a0,36 # 1470 <malloc+0x210>
     ...
     46a:	03a50513          	add	a0,a0,58 # 14a0 <malloc+0x240>
     ...
     4b8:	fbc50513          	add	a0,a0,-68 # 1470 <malloc+0x210>
     ...
     514:	fa850513          	add	a0,a0,-88 # 14b8 <malloc+0x258>
     ...
     540:	f9458593          	add	a1,a1,-108 # 14d0 <malloc+0x270>
     ...
     642:	e3250513          	add	a0,a0,-462 # 1470 <malloc+0x210>
     ...
     65c:	ec850513          	add	a0,a0,-312 # 1520 <malloc+0x2c0>
     ...
     670:	eb450513          	add	a0,a0,-332 # 1520 <malloc+0x2c0>
     ...
     688:	e4c58593          	add	a1,a1,-436 # 14d0 <malloc+0x270>
     ...
     6ce:	e5650513          	add	a0,a0,-426 # 1520 <malloc+0x2c0>
     6d2:	00000097          	auipc	ra,0x0
     6d6:	7be080e7          	jalr	1982(ra) # e90 <unlink>
     6da:	bc81                	j	12a <go+0xb2>
        printf("grind: create c failed\n");
     6dc:	00001517          	auipc	a0,0x1
     6e0:	e4c50513          	add	a0,a0,-436 # 1528 <malloc+0x2c8>
     ...
     6fa:	e4a50513          	add	a0,a0,-438 # 1540 <malloc+0x2e0>
     ...
     714:	e4850513          	add	a0,a0,-440 # 1558 <malloc+0x2f8>
     ...
     730:	e4450513          	add	a0,a0,-444 # 1570 <malloc+0x310>
     ...
     74a:	e5250513          	add	a0,a0,-430 # 1598 <malloc+0x338>
     ...
     832:	e0a58593          	add	a1,a1,-502 # 1638 <malloc+0x3d8>
     ...
     856:	dee50513          	add	a0,a0,-530 # 1640 <malloc+0x3e0>
     ...
     870:	c4c58593          	add	a1,a1,-948 # 14b8 <malloc+0x258>
     874:	4509                	li	a0,2
     ...
     88c:	c3058593          	add	a1,a1,-976 # 14b8 <malloc+0x258>
     890:	4509                	li	a0,2
     ...
     8e8:	cdc58593          	add	a1,a1,-804 # 15c0 <malloc+0x360>
     8ec:	4509                	li	a0,2
     ...
     95c:	b1858593          	add	a1,a1,-1256 # 1470 <malloc+0x210>
     960:	4509                	li	a0,2
     ...
     9a8:	c1c58593          	add	a1,a1,-996 # 15c0 <malloc+0x360>
     9ac:	4509                	li	a0,2
     ...
     9ec:	bd858593          	add	a1,a1,-1064 # 15c0 <malloc+0x360>
     9f0:	4509                	li	a0,2
     ...
     a54:	a2058593          	add	a1,a1,-1504 # 1470 <malloc+0x210>
     a58:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     a78:	a1450513          	add	a0,a0,-1516 # 1488 <malloc+0x228>
     a7c:	00000097          	auipc	ra,0x0
     a80:	414080e7          	jalr	1044(ra) # e90 <unlink>
  unlink("b");
     a84:	00001517          	auipc	a0,0x1
     a88:	9b450513          	add	a0,a0,-1612 # 1438 <malloc+0x1d8>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     aca:	9aa50513          	add	a0,a0,-1622 # 1470 <malloc+0x210>
  ...
  if(pid2 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     b14:	96050513          	add	a0,a0,-1696 # 1470 <malloc+0x210>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f24:	80850513          	add	a0,a0,-2040 # 1728 <digits>
     f28:	883a                	mv	a6,a4
     f2a:	2705                	addw	a4,a4,1
     f2c:	02c5f7bb          	remuw	a5,a1,a2
     f30:	1782                	sll	a5,a5,0x20
     f32:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    102a:	6aa70713          	add	a4,a4,1706 # 16d0 <malloc+0x470>
  ...
  putc(fd, 'x');
    ...
    10b6:	676b8b93          	add	s7,s7,1654 # 1728 <digits>
    10ba:	03c9d793          	srl	a5,s3,0x3c
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    10ce:	0992                	sll	s3,s3,0x4
    10d0:	397d                	addw	s2,s2,-1
    ...
    110c:	56090913          	add	s2,s2,1376 # 1668 <malloc+0x408>
        while(*s != 0){
...
{
    11a8:	711d                	add	sp,sp,-96
    11aa:	ec06                	sd	ra,24(sp)
    11ac:	e822                	sd	s0,16(sp)
    11ae:	1000                	add	s0,sp,32
...
free(void *ap)
{
    11de:	1141                	add	sp,sp,-16
    11e0:	e422                	sd	s0,8(sp)
    11e2:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    11e4:	ff050693          	add	a3,a0,-16
    ...
    1214:	00e6ea63          	bltu	a3,a4,1228 <free+0x4a>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    122e:	02059813          	sll	a6,a1,0x20
    1232:	01c85713          	srl	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    1242:	02061593          	sll	a1,a2,0x20
    1246:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
    1260:	7139                	add	sp,sp,-64
    1262:	fc06                	sd	ra,56(sp)
    1264:	f822                	sd	s0,48(sp)
    1266:	f426                	sd	s1,40(sp)
    1268:	ec4e                	sd	s3,24(sp)
    126a:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    126c:	02051493          	sll	s1,a0,0x20
    1270:	9081                	srl	s1,s1,0x20
    1272:	04bd                	add	s1,s1,15
    1274:	8091                	srl	s1,s1,0x4
    1276:	0014899b          	addw	s3,s1,1
    127a:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
    127c:	00001517          	auipc	a0,0x1
    1280:	d9453503          	ld	a0,-620(a0) # 2010 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12b0:	d6490913          	add	s2,s2,-668 # 2010 <freep>
  if(p == (char*)-1)
    12b4:	5afd                	li	s5,-1
    ...
    12c4:	14878793          	add	a5,a5,328 # 2408 <base>
  ...
  if(p == (char*)-1)
    ...
    132e:	c798                	sw	a4,8(a5)
        p += p->s.size;
    1330:	02071693          	sll	a3,a4,0x20
    1334:	01c6d713          	srl	a4,a3,0x1c
