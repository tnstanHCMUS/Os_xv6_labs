...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	2fe58593          	add	a1,a1,766 # 1310 <malloc+0x100>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	2c058593          	add	a1,a1,704 # 1320 <malloc+0x110>
      68:	4509                	li	a0,2
      6a:	00001097          	auipc	ra,0x1
      6e:	0c0080e7          	jalr	192(ra) # 112a <fprintf>
  exit(1);
      72:	4505                	li	a0,1
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	28e50513          	add	a0,a0,654 # 1328 <malloc+0x118>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	36270713          	add	a4,a4,866 # 1428 <malloc+0x218>
    ...
    panic("runcmd");
      ...
      e6:	24e50513          	add	a0,a0,590 # 1330 <malloc+0x120>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     108:	23458593          	add	a1,a1,564 # 1338 <malloc+0x128>
     10c:	4509                	li	a0,2
     10e:	00001097          	auipc	ra,0x1
     112:	01c080e7          	jalr	28(ra) # 112a <fprintf>
  exit(0);
     116:	4501                	li	a0,0
    ...
    runcmd(rcmd->cmd);
     ...
     154:	1f858593          	add	a1,a1,504 # 1348 <malloc+0x138>
     158:	4509                	li	a0,2
     15a:	00001097          	auipc	ra,0x1
     15e:	fd0080e7          	jalr	-48(ra) # 112a <fprintf>
      exit(1);
     162:	4505                	li	a0,1
    ...
    if(fork1() == 0){
     ...
     1ea:	17250513          	add	a0,a0,370 # 1358 <malloc+0x148>
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     28c:	f88080e7          	jalr	-120(ra) # 1210 <malloc>
     290:	84aa                	mv	s1,a0
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     2d6:	f3e080e7          	jalr	-194(ra) # 1210 <malloc>
     2da:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     330:	ee4080e7          	jalr	-284(ra) # 1210 <malloc>
     334:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     336:	4661                	li	a2,24
     338:	4581                	li	a1,0
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     376:	e9e080e7          	jalr	-354(ra) # 1210 <malloc>
     37a:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     37c:	4661                	li	a2,24
     37e:	4581                	li	a1,0
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3b8:	e5c080e7          	jalr	-420(ra) # 1210 <malloc>
     3bc:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     3be:	4641                	li	a2,16
     3c0:	4581                	li	a1,0
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5b8:	dcca8a93          	add	s5,s5,-564 # 1380 <malloc+0x170>
  ...
  while(peek(ps, es, "<>")){
     ...
     5ca:	d9a50513          	add	a0,a0,-614 # 1360 <malloc+0x150>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a2:	cea60613          	add	a2,a2,-790 # 1388 <malloc+0x178>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6de:	cceb0b13          	add	s6,s6,-818 # 13a8 <malloc+0x198>
  ...
  return ret;
     ...
     70c:	c8850513          	add	a0,a0,-888 # 1390 <malloc+0x180>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76e:	c2e50513          	add	a0,a0,-978 # 1398 <malloc+0x188>
...
0000000000000794 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7b4:	c0060613          	add	a2,a2,-1024 # 13b0 <malloc+0x1a0>
     7b8:	85ce                	mv	a1,s3
     7ba:	854a                	mv	a0,s2
...
0000000000000802 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     824:	b98a0a13          	add	s4,s4,-1128 # 13b8 <malloc+0x1a8>
  ...
  if(peek(ps, es, ";")){
     ...
     85a:	b6a60613          	add	a2,a2,-1174 # 13c0 <malloc+0x1b0>
     85e:	85ce                	mv	a1,s3
     860:	854a                	mv	a0,s2
...
00000000000008aa <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8c0:	acc60613          	add	a2,a2,-1332 # 1388 <malloc+0x178>
  ...
  if(!peek(ps, es, ")"))
     ...
     8f0:	aec60613          	add	a2,a2,-1300 # 13d8 <malloc+0x1c8>
     8f4:	85ca                	mv	a1,s2
     8f6:	8526                	mv	a0,s1
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     96e:	ad670713          	add	a4,a4,-1322 # 1440 <malloc+0x230>
...
00000000000009e6 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a1a:	90260613          	add	a2,a2,-1790 # 1318 <malloc+0x108>
     a1e:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a50:	9ac58593          	add	a1,a1,-1620 # 13f8 <malloc+0x1e8>
     a54:	4509                	li	a0,2
     a56:	00000097          	auipc	ra,0x0
     a5a:	6d4080e7          	jalr	1748(ra) # 112a <fprintf>
    panic("syntax");
     a5e:	00001517          	auipc	a0,0x1
     a62:	93250513          	add	a0,a0,-1742 # 1390 <malloc+0x180>
...
0000000000000a6e <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a82:	98a48493          	add	s1,s1,-1654 # 1408 <malloc+0x1f8>
     a86:	4589                	li	a1,2
     a88:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b38:	8dc58593          	add	a1,a1,-1828 # 1410 <malloc+0x200>
     b3c:	4509                	li	a0,2
     b3e:	00000097          	auipc	ra,0x0
     b42:	5ec080e7          	jalr	1516(ra) # 112a <fprintf>
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     ea6:	f6e080e7          	jalr	-146(ra) # e10 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
  if(sgn && xx < 0){
     ebe:	c299                	beqz	a3,ec4 <printint+0x12>
     ec0:	0805cb63          	bltz	a1,f56 <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ed4:	5e050513          	add	a0,a0,1504 # 14b0 <digits>
     ed8:	883a                	mv	a6,a4
     eda:	2705                	addw	a4,a4,1
     edc:	02c5f7bb          	remuw	a5,a1,a2
     ee0:	1782                	sll	a5,a5,0x20
     ee2:	9381                	srl	a5,a5,0x20
     ...
     ef6:	0685                	add	a3,a3,1
     ef8:	fec7f0e3          	bgeu	a5,a2,ed8 <printint+0x26>
  if(neg)
     efc:	00088c63          	beqz	a7,f14 <printint+0x62>
    buf[i++] = '-';
     f00:	fd070793          	add	a5,a4,-48
     f04:	00878733          	add	a4,a5,s0
     f08:	02d00793          	li	a5,45
     f0c:	fef70823          	sb	a5,-16(a4)
     f10:	0028071b          	addw	a4,a6,2

  while(--i >= 0)
     f14:	02e05c63          	blez	a4,f4c <printint+0x9a>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
     ...
     f6c:	1a090a63          	beqz	s2,1120 <vprintf+0x1c2>
  ...
  state = 0;
     ...
     f8a:	4b55                	li	s6,21
     f8c:	a839                	j	faa <vprintf+0x4c>
        putc(fd, c);
     f8e:	85ca                	mv	a1,s2
     f90:	8556                	mv	a0,s5
     f92:	00000097          	auipc	ra,0x0
     f96:	efe080e7          	jalr	-258(ra) # e90 <putc>
     f9a:	a019                	j	fa0 <vprintf+0x42>
    } else if(state == '%'){
     f9c:	01498d63          	beq	s3,s4,fb6 <vprintf+0x58>
  for(i = 0; fmt[i]; i++){
     fa0:	0485                	add	s1,s1,1
     fa2:	fff4c903          	lbu	s2,-1(s1)
     fa6:	16090763          	beqz	s2,1114 <vprintf+0x1b6>
    if(state == 0){
     faa:	fe0999e3          	bnez	s3,f9c <vprintf+0x3e>
      if(c == '%'){
     fae:	ff4910e3          	bne	s2,s4,f8e <vprintf+0x30>
        state = '%';
     fb2:	89d2                	mv	s3,s4
     fb4:	b7f5                	j	fa0 <vprintf+0x42>
      if(c == 'd'){
     fb6:	13490463          	beq	s2,s4,10de <vprintf+0x180>
     fba:	f9d9079b          	addw	a5,s2,-99
     fbe:	0ff7f793          	zext.b	a5,a5
     fc2:	12fb6763          	bltu	s6,a5,10f0 <vprintf+0x192>
     fc6:	f9d9079b          	addw	a5,s2,-99
     fca:	0ff7f713          	zext.b	a4,a5
     fce:	12eb6163          	bltu	s6,a4,10f0 <vprintf+0x192>
     fd2:	00271793          	sll	a5,a4,0x2
     fd6:	00000717          	auipc	a4,0x0
     fda:	48270713          	add	a4,a4,1154 # 1458 <malloc+0x248>
     fde:	97ba                	add	a5,a5,a4
     fe0:	439c                	lw	a5,0(a5)
     fe2:	97ba                	add	a5,a5,a4
     fe4:	8782                	jr	a5
     ...
     ff8:	ebe080e7          	jalr	-322(ra) # eb2 <printint>
     ffc:	8bca                	mv	s7,s2
      } else {
    ...
    1014:	ea2080e7          	jalr	-350(ra) # eb2 <printint>
    1018:	8bca                	mv	s7,s2
      state = 0;
    101a:	4981                	li	s3,0
    101c:	b751                	j	fa0 <vprintf+0x42>
    ...
    1030:	e86080e7          	jalr	-378(ra) # eb2 <printint>
    1034:	8bca                	mv	s7,s2
      state = 0;
    1036:	4981                	li	s3,0
    1038:	b7a5                	j	fa0 <vprintf+0x42>
    103a:	e062                	sd	s8,0(sp)
  ...
  putc(fd, 'x');
    ...
    1066:	44eb8b93          	add	s7,s7,1102 # 14b0 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    1086:	8be2                	mv	s7,s8
      state = 0;
    1088:	4981                	li	s3,0
    108a:	6c02                	ld	s8,0(sp)
    108c:	bf11                	j	fa0 <vprintf+0x42>
        s = va_arg(ap, char*);
    108e:	008b8993          	add	s3,s7,8
    1092:	000bb903          	ld	s2,0(s7)
        if(s == 0)
    1096:	02090163          	beqz	s2,10b8 <vprintf+0x15a>
        while(*s != 0){
    109a:	00094583          	lbu	a1,0(s2)
    109e:	c9a5                	beqz	a1,110e <vprintf+0x1b0>
          putc(fd, *s);
    10a0:	8556                	mv	a0,s5
    10a2:	00000097          	auipc	ra,0x0
    10a6:	dee080e7          	jalr	-530(ra) # e90 <putc>
          s++;
    10aa:	0905                	add	s2,s2,1
        while(*s != 0){
    10ac:	00094583          	lbu	a1,0(s2)
    10b0:	f9e5                	bnez	a1,10a0 <vprintf+0x142>
        s = va_arg(ap, char*);
    10b2:	8bce                	mv	s7,s3
      state = 0;
    10b4:	4981                	li	s3,0
    10b6:	b5ed                	j	fa0 <vprintf+0x42>
          s = "(null)";
    10b8:	00000917          	auipc	s2,0x0
    10bc:	36890913          	add	s2,s2,872 # 1420 <malloc+0x210>
        while(*s != 0){
    10c0:	02800593          	li	a1,40
    10c4:	bff1                	j	10a0 <vprintf+0x142>
        putc(fd, va_arg(ap, uint));
    10c6:	008b8913          	add	s2,s7,8
    10ca:	000bc583          	lbu	a1,0(s7)
    10ce:	8556                	mv	a0,s5
    10d0:	00000097          	auipc	ra,0x0
    10d4:	dc0080e7          	jalr	-576(ra) # e90 <putc>
    10d8:	8bca                	mv	s7,s2
      state = 0;
    10da:	4981                	li	s3,0
    10dc:	b5d1                	j	fa0 <vprintf+0x42>
        putc(fd, c);
    10de:	02500593          	li	a1,37
    10e2:	8556                	mv	a0,s5
    10e4:	00000097          	auipc	ra,0x0
    10e8:	dac080e7          	jalr	-596(ra) # e90 <putc>
      state = 0;
    10ec:	4981                	li	s3,0
    10ee:	bd4d                	j	fa0 <vprintf+0x42>
        putc(fd, '%');
    10f0:	02500593          	li	a1,37
    10f4:	8556                	mv	a0,s5
    10f6:	00000097          	auipc	ra,0x0
    10fa:	d9a080e7          	jalr	-614(ra) # e90 <putc>
        putc(fd, c);
    10fe:	85ca                	mv	a1,s2
    1100:	8556                	mv	a0,s5
    1102:	00000097          	auipc	ra,0x0
    1106:	d8e080e7          	jalr	-626(ra) # e90 <putc>
      state = 0;
    110a:	4981                	li	s3,0
    110c:	bd51                	j	fa0 <vprintf+0x42>
        s = va_arg(ap, char*);
    110e:	8bce                	mv	s7,s3
      state = 0;
    1110:	4981                	li	s3,0
    1112:	b579                	j	fa0 <vprintf+0x42>
    1114:	74e2                	ld	s1,56(sp)
    1116:	79a2                	ld	s3,40(sp)
    1118:	7a02                	ld	s4,32(sp)
    111a:	6ae2                	ld	s5,24(sp)
    111c:	6b42                	ld	s6,16(sp)
    111e:	6ba2                	ld	s7,8(sp)
    }
  }
}
    1120:	60a6                	ld	ra,72(sp)
    1122:	6406                	ld	s0,64(sp)
    1124:	7942                	ld	s2,48(sp)
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    119c:	e787b783          	ld	a5,-392(a5) # 2010 <freep>
    ...
    11c4:	00e6ea63          	bltu	a3,a4,11d8 <free+0x4a>
{
  ...
  freep = p;
    ...
    1206:	e0f73723          	sd	a5,-498(a4) # 2010 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1230:	de453503          	ld	a0,-540(a0) # 2010 <freep>
    1234:	c915                	beqz	a0,1268 <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    123a:	08977e63          	bgeu	a4,s1,12d6 <malloc+0xc6>
    123e:	f04a                	sd	s2,32(sp)
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    125c:	00001917          	auipc	s2,0x1
    1260:	db490913          	add	s2,s2,-588 # 2010 <freep>
  if(p == (char*)-1)
    1264:	5afd                	li	s5,-1
    1266:	a091                	j	12aa <malloc+0x9a>
    ...
    1274:	e1878793          	add	a5,a5,-488 # 2088 <base>
    ...
    if(p->s.size >= nunits){
    1286:	b7c1                	j	1246 <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    1288:	6398                	ld	a4,0(a5)
    128a:	e118                	sd	a4,0(a0)
    128c:	a08d                	j	12ee <malloc+0xde>
  hp->s.size = nu;
    128e:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    1292:	0541                	add	a0,a0,16
    1294:	00000097          	auipc	ra,0x0
    1298:	efa080e7          	jalr	-262(ra) # 118e <free>
  return freep;
    129c:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    12a0:	c13d                	beqz	a0,1306 <malloc+0xf6>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    12a2:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    12a4:	4798                	lw	a4,8(a5)
    12a6:	02977463          	bgeu	a4,s1,12ce <malloc+0xbe>
    if(p == freep)
    12aa:	00093703          	ld	a4,0(s2)
    12ae:	853e                	mv	a0,a5
    12b0:	fef719e3          	bne	a4,a5,12a2 <malloc+0x92>
  p = sbrk(nu * sizeof(Header));
    12b4:	8552                	mv	a0,s4
    12b6:	00000097          	auipc	ra,0x0
    12ba:	bc2080e7          	jalr	-1086(ra) # e78 <sbrk>
  if(p == (char*)-1)
    12be:	fd5518e3          	bne	a0,s5,128e <malloc+0x7e>
        return 0;
    12c2:	4501                	li	a0,0
    ...
    12cc:	a03d                	j	12fa <malloc+0xea>
    12ce:	7902                	ld	s2,32(sp)
    12d0:	6a42                	ld	s4,16(sp)
    12d2:	6aa2                	ld	s5,8(sp)
    12d4:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    12d6:	fae489e3          	beq	s1,a4,1288 <malloc+0x78>
        p->s.size -= nunits;
    12da:	4137073b          	subw	a4,a4,s3
    12de:	c798                	sw	a4,8(a5)
        p += p->s.size;
    12e0:	02071693          	sll	a3,a4,0x20
    12e4:	01c6d713          	srl	a4,a3,0x1c
    12e8:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    12ea:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    12ee:	00001717          	auipc	a4,0x1
    12f2:	d2a73123          	sd	a0,-734(a4) # 2010 <freep>
      return (void*)(p + 1);
    12f6:	01078513          	add	a0,a5,16
  }
}
    12fa:	70e2                	ld	ra,56(sp)
    12fc:	7442                	ld	s0,48(sp)
    12fe:	74a2                	ld	s1,40(sp)
