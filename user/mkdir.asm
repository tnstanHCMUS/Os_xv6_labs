...
main(int argc, char *argv[])
{
  ...
  44:	7e058593          	add	a1,a1,2016 # 820 <malloc+0x100>
  48:	4509                	li	a0,2
  ...
  62:	7da58593          	add	a1,a1,2010 # 838 <malloc+0x118>
  66:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e4:	4d850513          	add	a0,a0,1240 # 8b8 <digits>
 3e8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ea:	37a70713          	add	a4,a4,890 # 860 <malloc+0x140>
 ...
 576:	346b8b93          	add	s7,s7,838 # 8b8 <digits>
 57a:	03c9d793          	srl	a5,s3,0x3c
 ...
 58e:	0992                	sll	s3,s3,0x4
 590:	397d                	addw	s2,s2,-1
 ...
 5cc:	29090913          	add	s2,s2,656 # 858 <malloc+0x138>
        while(*s != 0){
 ...
 6d4:	00e6ea63          	bltu	a3,a4,6e8 <free+0x4a>
{
 ...
 6ec:	6390                	ld	a2,0(a5)
 6ee:	02059813          	sll	a6,a1,0x20
 6f2:	01c85713          	srl	a4,a6,0x1c
 ...
 6fc:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
 700:	4790                	lw	a2,8(a5)
 702:	02061593          	sll	a1,a2,0x20
 706:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
 ...
 72a:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 72c:	02051493          	sll	s1,a0,0x20
 730:	9081                	srl	s1,s1,0x20
 732:	04bd                	add	s1,s1,15
 734:	8091                	srl	s1,s1,0x4
 736:	0014899b          	addw	s3,s1,1
 73a:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
 ...
 770:	89490913          	add	s2,s2,-1900 # 1000 <freep>
  if(p == (char*)-1)
 774:	5afd                	li	s5,-1
 ...
 784:	89078793          	add	a5,a5,-1904 # 1010 <base>
