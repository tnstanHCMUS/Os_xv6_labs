...
00000000000001ec <main>:
{
 ...
 25e:	7f658593          	add	a1,a1,2038 # a50 <malloc+0x100>
 262:	4509                	li	a0,2
 ...
 294:	7e050513          	add	a0,a0,2016 # a70 <malloc+0x120>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 614:	4d850513          	add	a0,a0,1240 # ae8 <digits>
 618:	883a                	mv	a6,a4
 61a:	2705                	addw	a4,a4,1
 61c:	02c5f7bb          	remuw	a5,a1,a2
 620:	1782                	sll	a5,a5,0x20
 622:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 712:	00271793          	sll	a5,a4,0x2
 716:	00000717          	auipc	a4,0x0
 71a:	37a70713          	add	a4,a4,890 # a90 <malloc+0x140>
 ...
 7a6:	346b8b93          	add	s7,s7,838 # ae8 <digits>
 ...
 7fc:	29090913          	add	s2,s2,656 # a88 <malloc+0x138>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 95a:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 95c:	02051493          	sll	s1,a0,0x20
 960:	9081                	srl	s1,s1,0x20
 962:	04bd                	add	s1,s1,15
 964:	8091                	srl	s1,s1,0x4
 966:	0014899b          	addw	s3,s1,1
 96a:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
 ...
 9b4:	a6078793          	add	a5,a5,-1440 # 1410 <base>
