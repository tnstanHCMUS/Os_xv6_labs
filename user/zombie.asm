...
printint(int fd, int xx, int base, int sgn)
{
 ...
 394:	4a050513          	add	a0,a0,1184 # 830 <digits>
 398:	883a                	mv	a6,a4
 39a:	2705                	addw	a4,a4,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 49a:	34270713          	add	a4,a4,834 # 7d8 <malloc+0x108>
 ...
 526:	30eb8b93          	add	s7,s7,782 # 830 <digits>
 ...
 57c:	25890913          	add	s2,s2,600 # 7d0 <malloc+0x100>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 6da:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 6dc:	02051493          	sll	s1,a0,0x20
 6e0:	9081                	srl	s1,s1,0x20
 6e2:	04bd                	add	s1,s1,15
 6e4:	8091                	srl	s1,s1,0x4
 6e6:	0014899b          	addw	s3,s1,1
 6ea:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
 ...
 734:	8e078793          	add	a5,a5,-1824 # 1010 <base>
 ...
 79e:	c798                	sw	a4,8(a5)
        p += p->s.size;
 7a0:	02071693          	sll	a3,a4,0x20
 7a4:	01c6d713          	srl	a4,a3,0x1c
