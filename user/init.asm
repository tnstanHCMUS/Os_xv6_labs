...
main(void)
{
  ...
  12:	89250513          	add	a0,a0,-1902 # 8a0 <malloc+0x102>
  ...
  3a:	87290913          	add	s2,s2,-1934 # 8a8 <malloc+0x10a>
  3e:	854a                	mv	a0,s2
  ...
  6e:	88e50513          	add	a0,a0,-1906 # 8f8 <malloc+0x15a>
  ...
  8c:	81850513          	add	a0,a0,-2024 # 8a0 <malloc+0x102>
  90:	00000097          	auipc	ra,0x0
  94:	336080e7          	jalr	822(ra) # 3c6 <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	80650513          	add	a0,a0,-2042 # 8a0 <malloc+0x102>
  a2:	00000097          	auipc	ra,0x0
  a6:	31c080e7          	jalr	796(ra) # 3be <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	81450513          	add	a0,a0,-2028 # 8c0 <malloc+0x122>
  ...
  d2:	80a50513          	add	a0,a0,-2038 # 8d8 <malloc+0x13a>
  d6:	00000097          	auipc	ra,0x0
  da:	2e0080e7          	jalr	736(ra) # 3b6 <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	80250513          	add	a0,a0,-2046 # 8e0 <malloc+0x142>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 462:	51a50513          	add	a0,a0,1306 # 978 <digits>
 466:	883a                	mv	a6,a4
 468:	2705                	addw	a4,a4,1
 46a:	02c5f7bb          	remuw	a5,a1,a2
 46e:	1782                	sll	a5,a5,0x20
 470:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 560:	00271793          	sll	a5,a4,0x2
 564:	00000717          	auipc	a4,0x0
 568:	3bc70713          	add	a4,a4,956 # 920 <malloc+0x182>
 ...
 5f4:	388b8b93          	add	s7,s7,904 # 978 <digits>
 ...
 64a:	2d290913          	add	s2,s2,722 # 918 <malloc+0x17a>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7be:	85653503          	ld	a0,-1962(a0) # 1010 <freep>
 ...
 802:	82278793          	add	a5,a5,-2014 # 1020 <base>
